...
export const fr: Dict = {
  ...
  playlists: {
    ...
    emptyTitle: "[TO COMPLETE]",
    emptyLine: "[TO COMPLETE]",
    newPlaylist: "[TO COMPLETE]",
    untitled: "[TO COMPLETE]",
    playlistName: "[TO COMPLETE]",
    description: "[TO COMPLETE]",
    descriptionPlaceholder: "[TO COMPLETE]",
    details: "[TO COMPLETE]",
    trackCount: { one: "[TO COMPLETE]", other: "[TO COMPLETE]" },
    delete: "[TO COMPLETE]",
    deleteConfirm: "[TO COMPLETE]",
    ...
    noTracks: "[TO COMPLETE]",
    reorderTrack: "[TO COMPLETE]",
    removeTrack: "[TO COMPLETE]",
    addTo: "[TO COMPLETE]",
    pickerTitle: "[TO COMPLETE]",
    find: "[TO COMPLETE]",
    create: "[TO COMPLETE]",
    pickerEmpty: "[TO COMPLETE]",
    export: {
      action: "[TO COMPLETE]",
      title: "[TO COMPLETE]",
      m3uLabel: "[TO COMPLETE]",
      m3uDesc: "[TO COMPLETE]",
      folderLabel: "[TO COMPLETE]",
      folderDesc: "[TO COMPLETE]",
      richLabel: "[TO COMPLETE]",
      richDesc: "[TO COMPLETE]",
      warnDescription: "[TO COMPLETE]",
      warnCover: "[TO COMPLETE]",
      run: "[TO COMPLETE]",
    },
  },
