...
export const en = {
  ...
  home: {
    ...
    missingMetaLabel: "Missing metadata",
    missingMetaVerb: "need tags",
    missingMetaSettled: "All tagged",
    playNextLabel: "Play next",
    playNextInvite: "Nothing queued up next.",
    playNextInAlbum: "Next in {album}",
    playNextFromArtist: "More from {artist}",
    moreFromArtistLabel: "More from artist",
    moreFromArtistNamed: "More from {artist}",
    moreFromArtistInvite: "Play something and more by that artist lands here.",
    arrange: "Arrange",
    done: "Done",
    reset: "Reset",
    resetPrompt: "Reset this layout to its default?",
    addBox: "Add box",
    added: "Added",
    ...
    boxDesc: {
      missingCovers: "How many tracks still need cover art.",
      unsortedStat: "How many tracks are waiting to be sorted.",
      unsortedPreview: "A strip of the tracks waiting to be sorted.",
      recentlyPlayed: "The tracks you played most recently.",
      mostPlayed: "The tracks you play the most.",
      missingMetadata: "How many tracks are missing a title, artist, or album.",
      playNext: "One track to keep going, from your last played.",
      moreFromArtist: "A few tracks by the artist you play most.",
    },
  },
  ...
  history: {
    ...
    today: "Today",
    yesterday: "Yesterday",
    playCount: { one: "{{n}} play", other: "{{n}} plays" },
    completedPlay: "Played in full",
  ...
  tracks: {
    ...
    emptyLine: "Add a folder in Settings to build your library.",
    ...
    untagged: "Unknown",
    groupCount: { one: "{{n}} track", other: "{{n}} tracks" },
    selectAll: "Select all",
